...
! function(e) { "use strict";
    ...
    function i(e, i, t, a, o, r, n) { var s = e.find(i);
        s.css("borderWidth", r + "px"), s.css(t, 0 - r + "px"), s.css(a, "0px solid transparent"), s.css(o, n) } var t = jQuery.fn.revolution,
        a = (t.is_mobile(), t.is_android(), { alias: "LayerAnimation Min JS", name: "revolution.extensions.layeranimation.min.js", min_core: "5.4.6.4", version: "3.6.4" });
    jQuery.extend(!0, t, { updateMarkup: function(e, i) { var t = jQuery(e).data(); if (void 0 !== t.start && !t.frames_added && void 0 === t.frames) { var a = new Array,
                ...
                t.outframeindex = -1 === t.outframeindex ? -1 === t.hoverframeindex ? t.frames.length - 1 : t.frames.length - 2 : t.outframeindex, t.frames_added = !0 } }, animcompleted: function(e, i) { var a = e.data(),
                o = a.videotype,
                r = a.autoplay,
                n = a.autoplayonlyfirsttime;
            void 0 != o && "none" != o && (1 == r || "true" == r || "on" == r || "1sttime" == r || n ? (("carousel" !== i.sliderType || "carousel" === i.sliderType && "on" === i.carousel.showLayersAllTime && e.closest("li").hasClass("active-revslide") || "carousel" === i.sliderType && "on" !== i.carousel.showLayersAllTime && e.closest("li").hasClass("active-revslide")) && t.playVideo(e, i), t.toggleState(e.data("videotoggledby")), (n || "1sttime" == r) && (a.autoplayonlyfirsttime = !1, a.autoplay = "off")) : ("no1sttime" == r && (a.datasetautoplay = "on"), t.unToggleState(e.data("videotoggledby")))) }, handleStaticLayers: function(e, i) { var t = parseInt(e.data("startslide"), 0),
                a = parseInt(e.data("endslide"), 0);
            t < 0 && (t = 0), a < 0 && (a = i.realslideamount), 0 === t && a === i.realslideamount - 1 && (a = i.realslideamount + 1), e.data("startslide", t), e.data("endslide", a) }, animateTheCaptions: function(e) { if ("stop" === t.compare_version(a).check) return !1; var i = e.opt,
                o = e.slide,
                r = e.recall,
                n = e.maintimeline,
                s = e.preset,
            ...
            j(a, r, 0, o._responsive), a.hasClass("tp-resizeme") && a.find("*").each(function() { j(jQuery(this), r, "rekursive", o._responsive) }); var R = a.outerHeight(),
            ...
            o.eow = a.outerWidth(!0), o.eoh = a.outerHeight(!0), 0 == o.eow && 0 == o.eoh && (o.eow = r.ulw, o.eoh = r.ulh); var M = "off" !== o._respoffset ? parseInt(z, 0) * r.bw : parseInt(z, 0),
                P = "off" !== o._respoffset ? parseInt(O, 0) * r.bw : parseInt(O, 0),
                A = "grid" === o._ba ? r.gridwidth[r.curWinRange] * r.bw : o._gw,
                B = "grid" === o._ba ? r.gridheight[r.curWinRange] * r.bw : o._gh; "on" == r.fullScreenAlignForce && (A = r.ulw, B = r.ulh), "none" !== o._lig && void 0 != o._lig && (A = o._lig.width(), B = o._lig.height(), e.offsetx = 0, e.offsety = 0), Q = "center" === Q || "middle" === Q ? A / 2 - o.eow / 2 + P : "left" === Q ? P : "right" === Q ? A - o.eow - P : "off" !== o._respoffset ? Q * r.bw : Q, S = "center" == S || "middle" == S ? B / 2 - o.eoh / 2 + M : "top" == S ? M : "bottom" == S ? B - o.eoh - M : "off" !== o._respoffset ? S * r.bw : S, d && !o._slidelink && (Q += o.eow), o._slidelink && (Q = 0), o.calcx = parseInt(Q, 0) + e.offsetx, o.calcy = parseInt(S, 0) + e.offsety; var F = a.css("z-Index"); if ("row" !== o._nctype && "column" !== o._nctype) punchgs.TweenLite.set(o._pw, { zIndex: F, top: o.calcy, left: o.calcx, overwrite: "auto" });
            else if ("row" !== o._nctype) punchgs.TweenLite.set(o._pw, { zIndex: F, width: o.columnwidth, top: 0, left: 0, overwrite: "auto" });
            else if ("row" === o._nctype) { var X = "grid" === o._ba ? A + "px" : "100%";
                punchgs.TweenLite.set(o._pw, { zIndex: F, width: X, top: 0, left: e.offsetx, overwrite: "auto" }) } if (void 0 !== o.blendmode && punchgs.TweenLite.set(o._pw, { mixBlendMode: o.blendmode }), "row" === o._nctype && (o.columnbreak <= r.curWinRange ? a.addClass("rev_break_columns") : a.removeClass("rev_break_columns")), "on" == o.loopanimation && punchgs.TweenLite.set(o._lw, { minWidth: o.eow, minHeight: o.eoh }), "column" === o._nctype) { var Y = void 0 !== a[0]._gsTransform ? a[0]._gsTransform.y : 0,
            ...
            o._ingroup && "row" !== o._nctype && (void 0 !== o._groupw && !jQuery.isNumeric(o._groupw) && o._groupw.indexOf("%") > 0 && punchgs.TweenLite.set([o._lw, o._pw, o._mw], { minWidth: o._groupw }), void 0 !== o._grouph && !jQuery.isNumeric(o._grouph) && o._grouph.indexOf("%") > 0 && punchgs.TweenLite.set([o._lw, o._pw, o._mw], { minHeight: o._grouph })) }, createTimelineStructure: function(e) {
            function i(e, i, t, a) { var o, r = new punchgs.TimelineLite({ paused: !0 });
            ...
            e.timelines = e.timelines || new Object, e.c.find(".tp-revslider-slidesli, .tp-static-layers").each(function() { var t = jQuery(this),
                    a = t.data("index");
                e.timelines[a] = e.timelines[a] || {}, e.timelines[a].layers = e.timelines[a].layers || new Object, t.find(".tp-caption").each(function(t) { i(jQuery(this), e, e.timelines[a].layers, a) }) }) }, buildFullTimeLine: function(e) { var i, a, o = e.caption,
                r = o.data(),
                n = e.opt,
                d = {},
                l = h(); if (!(i = n.timelines[r._slideid].layers[r._id]).generated || !0 === e.regenerate) { if (a = i.timeline, i.generated = !0, void 0 !== r.current_timeline && !0 !== e.regenerate ? (r.current_timeline_pause = r.current_timeline.paused(), r.current_timeline_time = r.current_timeline.time(), r.current_is_nc_timeline = a === r.current_timeline, r.static_layer_timeline_time = r.current_timeline_time) : (r.static_layer_timeline_time = r.current_timeline_time, r.current_timeline_time = 0, r.current_timeline && r.current_timeline.clear()), a.clear(), d.svg = void 0 != r.svg_src && o.find("svg"), d.svg && (r.idlesvg = g(r.svg_idle, p()), punchgs.TweenLite.set(d.svg, r.idlesvg.anim)), -1 !== r.hoverframeindex && void 0 !== r.hoverframeindex && !o.hasClass("rs-hover-ready")) { if (o.addClass("rs-hover-ready"), r.hovertimelines = {}, r.hoveranim = _(l, r.frames[r.hoverframeindex].to), r.hoveranim = w(r.hoveranim, r.frames[r.hoverframeindex].style), d.svg) { var m = g(r.svg_hover, p());
                        void 0 != r.hoveranim.anim.color && (m.anim.fill = r.hoveranim.anim.color, r.idlesvg.anim.css.fill = d.svg.css("fill")), r.hoversvg = m }
                    o.hover(function(e) { var i = { caption: jQuery(e.currentTarget), opt: n, firstframe: "frame_0", lastframe: "frame_999" },
                            t = (s(i), i.caption),
                            a = t.data(),
            ...
            e.fromcurrentstate && (W.anim.immediateRender = !0); var O = -1; if (0 === d && !e.fromcurrentstate && void 0 !== t._bmask && void 0 !== T && T.indexOf("block") >= 0 || d === t.outframeindex && !e.fromcurrentstate && void 0 !== t._bmask && void 0 !== T && T.indexOf("block") >= 0) { var Q = 0 === d ? R.speed / 1e3 / 2 : W.speed / 1e3 / 2,
                ...
                for (var o = 0; o < i.timeline_obj.dchildren.length; o++) t.endMoveCaption({ caption: jQuery(i.timeline_obj.dchildren[o]), opt: e.opt }) }, playAnimationFrame: function(e) { e.firstframe = e.triggerframein, e.lastframe = e.triggerframeout; var i, a = s(e),
                o = e.caption.data(),
                r = 0; for (var n in o.frames) o.frames[n].framename === e.frame && (i = r), r++;
            void 0 !== o.triggeredtimeline && o.triggeredtimeline.pause(), o.triggeredtimeline = new punchgs.TimelineLite, a.timeline.pause(); var d = !0 === o.visibleelement;
            o.triggeredtimeline = t.createFrameOnTimeline({ caption: e.caption, timeline: o.triggeredtimeline, label: "triggered", frameindex: i, updateStaticTimeline: !0, opt: e.opt, ignorefirstframe: !0, fromcurrentstate: d }).play() }, removeTheCaptions: function(e, i) { if ("stop" === t.compare_version(a).check) return !1; var o = e.data("index"),
                r = new Array;
            i.layers[o] && jQuery.each(i.layers[o], function(e, i) { r.push(i) }); var n = t.currentSlideIndex(i);
            r && jQuery.each(r, function(e) { var a = jQuery(this); "carousel" === i.sliderType && "on" === i.carousel.showLayersAllTime ? (clearTimeout(a.data("videoplaywait")), t.stopVideo && t.stopVideo(a, i), t.removeMediaFromList && t.removeMediaFromList(a, i), i.lastplayedvideos = []) : (W(a), clearTimeout(a.data("videoplaywait")), t.endMoveCaption({ caption: a, opt: i, currentslide: n }), t.removeMediaFromList && t.removeMediaFromList(a, i), i.lastplayedvideos = []) }) } }); var o = function(e, i, a, o, r, n, s, d, l) { var m = {}; if (m.layer = s, m.eventtype = 0 === e ? "enterstage" : e === o.outframeindex ? "leavestage" : "framestarted", m.layertype = s.data("layertype"), o.active = !0, m.frame_index = e, m.layersettings = s.data(), l.c.trigger("revolution.layeraction", [m]), "on" == o.loopanimation && I(o._lw, l.bw), "enterstage" === m.eventtype && (o.animdirection = "in", o.visibleelement = !0, t.toggleState(o.layertoggledby)), "none" !== i.dchildren && void 0 !== i.dchildren && i.dchildren.length > 0)
                ...
                for (var c = 0; c < i.dchildren.length; c++) t.endMoveCaption({ caption: jQuery(i.dchildren[c]), opt: l, checkchildrens: !0 });
        ...
        I = function(e, i) { var t = e.data(); if (e.hasClass("rs-pendulum") && void 0 == t._loop_timeline) { t._loop_timeline = new punchgs.TimelineLite; var a = void 0 == e.data("startdeg") ? -20 : e.data("startdeg"),
                ...
                a *= i, o *= i, t._loop_timeline.append(new punchgs.TweenLite.fromTo(e, r, { force3D: "auto", rotation: a, transformOrigin: n }, { rotation: o, ease: s })), t._loop_timeline.append(new punchgs.TweenLite.fromTo(e, r, { force3D: "auto", rotation: o, transformOrigin: n }, { rotation: a, ease: s, onComplete: function() { t._loop_timeline.restart() } })) } if (e.hasClass("rs-rotate") && void 0 == t._loop_timeline) { t._loop_timeline = new punchgs.TimelineLite; var a = void 0 == e.data("startdeg") ? 0 : e.data("startdeg"),
                    o = void 0 == e.data("enddeg") ? 360 : e.data("enddeg"),
                    r = void 0 == e.data("speed") ? 2 : e.data("speed"),
                    n = void 0 == e.data("origin") ? "50% 50%" : e.data("origin"),
                    s = void 0 == e.data("easing") ? punchgs.Power2.easeInOut : e.data("easing");
                a *= i, o *= i, t._loop_timeline.append(new punchgs.TweenLite.fromTo(e, r, { force3D: "auto", rotation: a, transformOrigin: n }, { rotation: o, ease: s, onComplete: function() { t._loop_timeline.restart() } })) } if (e.hasClass("rs-slideloop") && void 0 == t._loop_timeline) { t._loop_timeline = new punchgs.TimelineLite; var d = void 0 == e.data("xs") ? 0 : e.data("xs"),
                    l = void 0 == e.data("ys") ? 0 : e.data("ys"),
                    m = void 0 == e.data("xe") ? 0 : e.data("xe"),
                    c = void 0 == e.data("ye") ? 0 : e.data("ye"),
                    r = void 0 == e.data("speed") ? 2 : e.data("speed"),
                    s = void 0 == e.data("easing") ? punchgs.Power2.easeInOut : e.data("easing");
                d *= i, l *= i, m *= i, c *= i, t._loop_timeline.append(new punchgs.TweenLite.fromTo(e, r, { force3D: "auto", x: d, y: l }, { x: m, y: c, ease: s })), t._loop_timeline.append(new punchgs.TweenLite.fromTo(e, r, { force3D: "auto", x: m, y: c }, { x: d, y: l, onComplete: function() { t._loop_timeline.restart() } })) } if (e.hasClass("rs-pulse") && void 0 == t._loop_timeline) { t._loop_timeline = new punchgs.TimelineLite; var p = void 0 == e.data("zoomstart") ? 0 : e.data("zoomstart"),
                    g = void 0 == e.data("zoomend") ? 0 : e.data("zoomend"),
                    r = void 0 == e.data("speed") ? 2 : e.data("speed"),
                    s = void 0 == e.data("easing") ? punchgs.Power2.easeInOut : e.data("easing");
                t._loop_timeline.append(new punchgs.TweenLite.fromTo(e, r, { force3D: "auto", scale: p }, { scale: g, ease: s })), t._loop_timeline.append(new punchgs.TweenLite.fromTo(e, r, { force3D: "auto", scale: g }, { scale: p, onComplete: function() { t._loop_timeline.restart() } })) } if (e.hasClass("rs-wave") && void 0 == t._loop_timeline) { t._loop_timeline = new punchgs.TimelineLite; var f = void 0 == e.data("angle") ? 10 : parseInt(e.data("angle"), 0),
                    ...
                    v = new Object;
                u.length >= 1 ? (v.x = u[0], v.y = u[1]) : (v.x = "50%", v.y = "50%"); var _ = { a: 0, ang: f, element: e, unit: h *= i, xoffset: 0 + (parseInt(v.x, 0) / 100 - .5) * e.width(), yoffset: -1 * h + (parseInt(v.y, 0) / 100 - .5) * e.height() },
                    b = parseInt(f, 0),
                    y = new punchgs.TweenLite.fromTo(_, r, { a: 0 + b }, { a: 360 + b, force3D: "auto", ease: punchgs.Linear.easeNone });
                y.eventCallback("onUpdate", function(e) { var i = e.a * (Math.PI / 180),
                        t = e.yoffset + e.unit * (1 - Math.sin(i)),
                        a = e.xoffset + Math.cos(i) * e.unit;
                    punchgs.TweenLite.to(e.element, .1, { force3D: "auto", x: a, y: t }) }, [_]), y.eventCallback("onComplete", function(e) { e._loop_timeline.restart() }, [t]), t._loop_timeline.append(y) } },
        W = function(e) { e.closest(".rs-pendulum, .rs-slideloop, .rs-pulse, .rs-wave").each(function() { var e = this;
                void 0 != e._loop_timeline && (e._loop_timeline.pause(), e._loop_timeline = null) }) } }(jQuery);