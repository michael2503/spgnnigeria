...
<div class="content-page">
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <form method="POST" action="{{ route('submitUpdatedBlog') }}" id="myAwesomeDropzone" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card-box">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="category" class="form-control" id="">
                                    ...
                                    <option @if($cat->slug == $blog->category) selected @endif value="{{ $cat->slug }}">{{ $cat->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="formErr">{{$errors->first('status')}}</div>
                            </div>

                            <h5 class="text-uppercase mt-0 mb-1 bg-light p-2">Blog Image</h5>
                            <div class="mt-3">
                                <input type="file" class="dropify" data-default-file="{{ $blog->image }}" name="photo"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card-box">
                            <h5 class="text-uppercase mt-0 mb-1 bg-light p-2 mb-4">Blog Info</h5>

                            <h5 class="text-uppercase mt-0 mb-1 bg-light p-2 mb-3">
                            ...
                            <h5 class="text-uppercase mt-0 mb-1 bg-light p-2 mb-3">
                                <div class="d-flex justify-content-between">
                                    <div>Comments</div>
                                    <div>{{ $comments }} <a href="{{ route('viewComments', $blog->id) }}" class="badge badge-success">View</a></div>
                                </div>
                            </h5>
                            <h5 class="text-uppercase mt-0 mb-1 bg-light p-2 mb-3">
                                <div class="d-flex justify-content-between">
                                    <div>Created On</div>
                                    <div>{{ date('M d, Y', strtotime($blog->created_at)) }}</div>
                                </div>
                            </h5>
                            <h5 class="text-uppercase mt-0 mb-1 bg-light p-2 mb-3">
                                <div class="d-flex justify-content-between">
                            ...
                            <h5 class="text-uppercase mt-0 mb-1 bg-light p-2 mb-3">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>{{ date('M d, Y', strtotime($blog->updated_at)) }}</div>
                                </div>
                            </h5>
