            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="card-box">
                        ...
                        <form method="post" action="{{ route('submitGalleryCategory') }}">
                            @csrf
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body text-center">
          ...
          <form method="post" action="{{ route('deleteGalleryCategory') }}">
            @csrf
...
<div class="modal fade" id="editModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">EDIT Gallery CATEGORY</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>

        <!-- Modal body -->
        <div class="modal-body">
          <form method="post" action="{{ route('updateGalleryCategory') }}">
            @csrf
            @method('put')
            <input type="hidden" name="catGalID" id="deleteIDEdit">
