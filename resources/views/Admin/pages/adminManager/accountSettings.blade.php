...
<div class="content-page">
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <form method="post" id="myAwesomeDropzone" action="{{ route('submitEditProfile') }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card-box">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="hidden" name="id" id="first_name" class="form-control" value="{{ $admin->id }}">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="username" id="username" class="form-control" value="{{ $admin->username }}" readonly>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="role" id="role" class="form-control" value="{{ $admin->role }}" readonly>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-12 col-md-6 col-sm-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="country" id="country" class="form-control" value="{{ $admin->country }}">
                                ...
                                <div class="col-xl-6 col-lg-12 col-md-6 col-sm-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="state" id="state" class="form-control" value="{{ $admin->state }}">
                    ...
                    <div class="col-lg-6">
                        <div class="card-box">
                            ...
                            <div class="mt-3">
                                <input type="file" class="dropify" data-max-file-size="1M" data-default-file="{{ $admin->photo }}" name="photo" />
                        ...
                        <div class="card-box">
                            ...
                            <div class="mt-3">
                                <textarea name="bio" class="form-control" rows="9">{{ $admin->bio }}</textarea>
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="text-center mb-3">
                            <button type="submit" class="btn w-sm btn-success waves-effect waves-light">Update Admin</button>
                        </div>
                    </div> <!-- end col -->
                </div>
                <!-- end row -->
